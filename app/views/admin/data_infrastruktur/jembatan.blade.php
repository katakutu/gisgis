...
@section('content')
	...
	<div id="content_body">
		...
		<div id="kanan">
			{{HTML::link('admin/data_infrastruktur/jembatan/tambah', 'Tambah Jembatan', array('id'=>'tambah'))}}
			<table cellspacing="0">
				<tr>
				...
				<tr>
					...
					<td>{{$value->lebar}} m</td>
					<td>{{HTML::link('admin/data_infrastruktur/jembatan/edit/'.$value->id, 'Edit')}} | {{HTML::link('admin/data_infrastruktur/jembatan/delete/'.$value->id, 'Delete')}}</td>
				</tr>
				<?php $loop++ ?>
				@endforeach
			</table>
