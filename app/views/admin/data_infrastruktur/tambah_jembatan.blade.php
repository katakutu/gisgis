	...
	<div id="content_body">
		...
		<div id="kanan">
			<form action="" method="post" enctype="multipart/form-data">
				...
				<input type="text" name="bahan_lantai"><br>
				<label for="">Kondisi Lantai</label>
				<input type="text" name="kondisi_lantai"><br>
				<label for="">Bahan Pondasi</label>
				<input type="text" name="bahan_pondasi"><br>
				<label for="">Kondisi Pondasi</label>
				<input type="text" name="kondisi_pondasi"><br>
