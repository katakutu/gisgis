...
@section('menu_item')
	...
	{{HTML::link('admin/profil', 'Profil', array('class'=>'menu_item', 'id'=>'selected'))}}
...
@section('content')
	...
	<div id="content_body">
		@foreach($profil_array as $key=>$value)
			<div class="post">
				<div class="thumb">
				...
				<div class="action">
					...
					{{HTML::link('admin/up/'.$value->id, 'Up')}} | 
					{{HTML::link('admin/down/'.$value->id, 'Down')}} | 
